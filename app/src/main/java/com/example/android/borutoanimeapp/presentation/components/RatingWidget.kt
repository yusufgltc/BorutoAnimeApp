...
import com.example.android.borutoanimeapp.ui.theme.EXTRA_SMALL_PADDING
import com.example.android.borutoanimeapp.ui.theme.StarColor
...
fun calculateStars(rating: Double): Map<String, Int> {
    ...
    LaunchedEffect(key1 = rating) {
        ...
        if (filledStars in 0..5 && lastNumber in 0..9) {
